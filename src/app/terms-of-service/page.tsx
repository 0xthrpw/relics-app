    ...
    <>
      <main className='px-lg @[40rem]/app:px-xl mx-auto flex max-w-4xl flex-col items-start gap-6 py-8 font-medium @[40rem]/app:items-center'>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            By accessing or using Relics, you agree to these Terms of Service (“Terms”). If you do not agree, do not use
            the service.
          </p>
        </div>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>Relics is an online manager and market interface for Ethereum Name Service (“ENS”) names.</p>
          <p>Relics does not:</p>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            Relics is provided “as is” and “as available.” We make no warranties regarding availability, accuracy,
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            Use of Relics is at your own risk. To the maximum extent permitted by law, Follow Protocol Foundation shall
            not be liable for:
          </p>
          <ul className='list-inside list-disc'>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            Relics relies on third-party infrastructure and protocols, including Ethereum, ENS, wallet providers, and
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <ul className='list-inside list-disc'>
            <li>Use Relics for unlawful purposes</li>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <ul className='list-inside list-disc'>
            <li>Suspend or terminate access to Relics</li>
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            Any dispute arising out of or relating to Relics or these Terms shall be resolved through binding
        ...
        <div className='flex w-full flex-col gap-1'>
          ...
          <p>
            We may modify these Terms at any time. Continued use of Relics after changes means you accept the updated
            Terms.
          </p>
        </div>
      </main>
