  ...
  return new ImageResponse(
    <div
      style={{
        ...
        flexDirection: 'row',
        backgroundImage: 'radial-gradient(circle, #3a322a, #191512)',
        textAlign: 'center',
        fontWeight: 700,
        fontFamily: 'Inter',
      }}
      ...
      >
        ...
        <svg width='125' height='44' viewBox='0 0 125 44' fill='none' xmlns='http://www.w3.org/2000/svg'>
          ...
          <path
            ...
            fill='#262019'
          />
          <path d='M24.5327 20.9182L30.7845 10.5137L36.9907 20.9182L30.7845 24.7058L24.5327 20.9182Z' fill='#262019' />
          <path d='M30.7845 25.8466L24.5327 22.059L30.7845 30.8663L36.9907 22.059L30.7845 25.8466Z' fill='#262019' />
          <path
